...
[![format-tests](https://github.com/3scale-sre/tf-vault-secret/workflows/format-tests/badge.svg)](https://github.com/3scale-sre/tf-vault-secret/actions/workflows/format-tests.yaml?query=workflow%3Aformat-tests)
[![license](https://badgen.net/github/license/3scale-sre/tf-vault-secret)](https://github.com/3scale-sre/tf-vault-secret/blob/main/LICENSE)

This module tries to standarize the way we store secrets in the KeyValueV2 Vault's storage engine. It leverages the existent naming convention and implemented in https://github.com/3scale-sre/tf-aws-label to create secrets in a consistent way.
...
```
module "vault_secret" {
  source      = "git@github.com:3scale-sre/tf-vault-secret.git?ref=tags/0.1.0"
  write       = true
  scope       = "teams"
  owner       = "operations"
...
```
module "user_label" {
  source      = "git@github.com:3scale-sre/tf-aws-label.git?ref=tags/0.1.1"
  environment = local.environment
  project     = local.project
  workload    = local.workload
  type        = "some-type"
...
```
module "vault_secret" {
  source  = "/home/roi/github.com/3scale-sre/tf-vault-secret"
  context = module.user_label.context
  write   = true
...
- Fixing issues by opening [Pull Requests](https://github.com/3scale-sre/tf-vault-secret/pulls)
- Submitting a patch or opening a PR
- Improving documentation
- Talking about the operator

All bugs, tasks or enhancements are tracked as [GitHub issues](https://github.com/3scale-sre/tf-vault-secret/issues).
